...
void WorldSession::HandlePlayerBotLogin(LoginQueryHolder* holder)
{
    ...
    WorldSession* botSession = new WorldSession(holder->GetAccountId(), NULL, mSession->GetSecurity(), mSession->IsPremium(), mSession->Expansion(), 0, mSession->GetSessionDbcLocale(), 0, false);
