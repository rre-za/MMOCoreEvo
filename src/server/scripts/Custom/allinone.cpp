...
class JustWoW_allinone : public CreatureScript
{
    public:

        JustWoW_allinone()
            : CreatureScript("JustWoW_allinone")
        {
        }

        struct JustWoW_allinoneAI : public ScriptedAI
        {
	    //*** HANDLED FUNCTION ***
        //This is the constructor, called only once when the Creature is first created
            JustWoW_allinoneAI(Creature *c) : ScriptedAI(c) {}   
        }; 
...
bool OnGossipHello(Player  *player, Creature* pCreature)
{
	...
	if (ConfigMgr::GetBoolDefault("JustWoW_allinone.OnlyGMs", false)) // If JustWoW_allinone.OnlyGMs is enabled in trinitycore.conf
	...
	bool EnableBuffs = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableBuffs", true);
	bool EnableProfessionsSkillUp = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableProfessionsSkillUp", true);
	bool EnableTrainers = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableTrainers", true);
	bool EnableBots = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableBots", true);
	bool EnablePlayerTools = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnablePlayerTools", true);
	bool EnableRemoveResSickness = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableRemoveResSickness", true);
	bool EnableMorph = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableMorph", true);
...
void SendDefaultMenu_JustWoW_allinone(Player  *player, Creature* pCreature, uint32 uiAction)
{
...
if (!ConfigMgr::Load(_TRINITY_CORE_CONFIG))
	...
	bool EnableBuffs = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableBuffs", true);
	bool EnableProfessionsSkillUp = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableProfessionsSkillUp", true);
	bool EnableSmallBuff = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableSmallBuff", true);
	bool EnableGreatBuff = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableGreatBuff", true);
	bool EnableGMBuff = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableGMBuff", true);
	bool EnableTrainers = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableTrainers", true);
	bool EnableClassTrainers = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableClassTrainers", true);
	bool EnableProfessionsTrainers = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableProfessionsTrainers", true);
	bool EnablePlayerTools = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnablePlayerTools", true);
	bool EnableRemoveResSickness = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableRemoveResSickness", true);
	bool EnableGivemeGold = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableGivemeGold", true);
	bool EnableProfessions = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableProfessions", true);
	bool EnableSecondarySkills = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableSecondarySkills", true);
	bool EnableMorph = ConfigMgr::GetBoolDefault("JustWoW_allinone.EnableMorph", true);

//Mony Check
if (player->GetMoney() < (ConfigMgr::GetFloatDefault("JustWoW_allinoneBuffGoldCost",0)))
{
    player->CLOSE_GOSSIP_MENU();
...
case 1001: // Buff me Mark of the Wild
    ...
    player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneBuffGoldCost",0)));
break;
...
case 1101: // Alchemy
	...
	player->UpdateSkill(171,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1102: // Blacksmithing
	...
	player->UpdateSkill(164,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1103: // Enchanting
	...
	player->UpdateSkill(333,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1104: // Engineering
	...
	player->UpdateSkill(202,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1105: // Herbalism
	...
	player->UpdateSkill(182,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1106: // Inscription
	...
	player->UpdateSkill(773,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1107: // Jewelcrafting
	...
	player->UpdateSkill(755,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1108: // Leatherworking
	...
	player->UpdateSkill(165,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1109: // Mining
	...
	player->UpdateSkill(186,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1110: // Skinning
	...
	player->UpdateSkill(393,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 1111: // Tailoring
	...
	player->UpdateSkill(197,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 2101: // Cooking
	...
	player->UpdateSkill(185,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 2102: // First Aid
	...
	player->UpdateSkill(129,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
case 2103: // Fishing
	...
	player->UpdateSkill(356,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
	player->CLOSE_GOSSIP_MENU();
break;
...
//	}
//
//	player->UpdateSkill(,(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillPoints",0)));
//	player->ModifyMoney(-(ConfigMgr::GetFloatDefault("JustWoW_allinoneSkillGoldCost",0)));
//	player->CLOSE_GOSSIP_MENU();
//break;
 player->CLOSE_GOSSIP_MENU();
...
bool OnGossipSelect(Player  *player, Creature* pCreature, uint32 uiSender, uint32 uiAction)
{
	...
	SendDefaultMenu_JustWoW_allinone(player, pCreature, uiAction);
